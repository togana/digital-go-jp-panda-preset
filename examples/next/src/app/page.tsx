...
export default function Home() {
  return (
    <>
      <div className={css({ textStyle: 'Dsp-64B-140', backgroundColor: 'success-1' })}>Hello 🐼!</div>
      <div className={css({ textStyle: 'Dsp-57B-140', backgroundColor: 'error-1' })}>Hello 🐼!</div>
      <div className={css({ textStyle: 'Dsp-48B-140', backgroundColor: 'warning-yellow-1' })}>Hello 🐼!</div>
